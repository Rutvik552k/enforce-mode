...
- [CRITICAL] GRACEFUL DEGRADATION: Critical user paths must have fallback behavior on error. Payment failures should suggest retry. Search failures should show cached results. Never dead-end the user.
