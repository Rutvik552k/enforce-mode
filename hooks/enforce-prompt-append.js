...
const APPEND_TEXT = [
  ...
  '- Prior-art before design: don’t design from the tutorial default. Name the problem’s algorithmic class, study how ≥2 production systems (named companies) solved it — named algorithm + a REAL cited source (eng blog/paper/talk) — then reverse-engineer + adapt with Big-O, recorded in design-dossier.md. An uncited "company X uses Y" claim is UNVERIFIED — verify or drop it.',
